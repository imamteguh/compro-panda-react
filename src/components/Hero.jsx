...
const Hero = () => {
  return (
    <section className="relative mt-6 overflow-hidden bg-gray-50 py-12 px-4 sm:px-6 md:px-8 lg:py-16 lg:px-20
      ...
      <div className="flex-1 lg:ml-28 w-full max-w-xl space-y-6 relative z-20">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-6 lg:gap-48 items-center lg:items-start mt-8">
          <div className="bg-white w-72 rounded-3xl p-6 border border-gray-100 shadow-xl lg:shadow-2xl transition"
            ...
            <h3 className="ml-4 text-xl font-semibold text-gray-800">Service Subtitle One</h3>
          ...
          <div className="bg-white w-72 rounded-3xl p-6 border border-gray-100 shadow-xl lg:shadow-2xl transition"
            ...
            <h3 className="ml-4 text-xl font-semibold text-gray-800">Service Subtitle Two</h3>
            <p className="ml-4 text-gray-500 text-sm mt-2">
              Lorem ipsum dolor sit, amet consectetur adipisicing elit.
            </p>
          </div>
      ...
      <div className="flex-1 mt-12 lg:mt-0 lg:ml-12 relative w-full flex justify-center"
        ...
        <div className="w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 lg:w-[600px] lg:h-[500px] 
          overflow-hidden border-8 border-white shadow-lg relative z-10
          rounded-[60%_40%_30%_60%/60%_30%_60%_40%]">
